...
#Steps
#1. Get state of the game from lua
#2. Use that as an input vector on a trained model
#3. Send actions (output vector) to game via lua?
...
# Restrictions
# Ancient Era Only
# Tiny Skirmish, Standard Speed
# No City States
# No Barbarians
# One City only
# Poland Only
# No culture no science?
# Happiness?
# No trade routes

#Each turn
# Food accumulates
# Production accumulate
# Science/culture accumulate
# Units move, attack or fortify
